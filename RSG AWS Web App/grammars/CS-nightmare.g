...
{
<start> 
<code-phrase> <failure-reason> because it went <initial-pointer-problem>  
So I ran it under gdb, but <gdb-problem>  So I tried Purify, which told me
<purify-problem>  I've got to remember to <general-lament> 	;
}
